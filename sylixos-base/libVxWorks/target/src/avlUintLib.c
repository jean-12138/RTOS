 ...
 */
STATUS avlUintInsert (AVLU_TREE *pRoot,     /* pointer to the root node ptr */
 ...
 */
AVLU_NODE *avlUintDelete (AVLU_TREE *pRoot,     /* pointer to the root node pointer */
                          UINT       key)       /* search key of node we want to delete */
{
    AVLU_NODE **ppNode;                     /* ptr to current node ptr */
    AVLU_NODE  *pNode = NULL;               /* ptr to the current node */
    AVLU_NODE **ancestor[AVLU_MAX_HEIGHT];  /* ancestor node pointer list */
    int         ancestorCount;              /* number of ancestors */
 ...
 */
AVLU_NODE *avlUintSearch (AVLU_TREE root,   /* root node pointer */
                          UINT      key)    /* search key */
{
    AVLU_NODE *pNode;      /* pointer to the current node */
 ...
 */
AVLU_NODE *avlUintSuccessorGet (AVLU_TREE   root,   /* root node pointer */
                                UINT        key)    /* search key */
{
    AVLU_NODE *pNode;       /* pointer to the current node */
 ...
 */
AVLU_NODE *avlUintPredecessorGet (AVLU_TREE   root,     /* root node pointer */
                                  UINT        key)      /* search key */
{
    AVLU_NODE *pNode;      /* pointer to the current node */
 ...
 */
AVLU_NODE *avlUintMinimumGet (AVLU_TREE   root)     /* root node pointer */
{
    if (NULL == root) {
        return  (NULL);
    }
 ...
 */
AVLU_NODE *avlUintMaximumGet (AVLU_TREE   root)       /* root node pointer */
{
    if (NULL == root) {
        return  (NULL);
    }
 ...
 */
STATUS avlUintTreeWalk (AVLU_TREE     root,     /* root node pointer */
 ...
 */
LOCAL void avlUintRebalance (AVLU_NODE ***ancestors,  /* ancestor list */
